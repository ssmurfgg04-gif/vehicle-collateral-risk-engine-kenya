...
// ContainsNoticeLink checks if a URL points to a notice/detail page.
func ContainsNoticeLink(url string) bool {
        return strings.Contains(url, "/notice") ||
                strings.Contains(url, "/public-notice") ||
                strings.Contains(url, "/disposal") ||
                strings.Contains(url, "/detail")
}

// ContainsPaginationLink checks if a URL is a pagination link.
func ContainsPaginationLink(url string) bool {
        return strings.Contains(url, "page=") ||
